...
if (submitBtn) {
  submitBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
      ...
      const bookings = JSON.parse(localStorage.getItem('Adusab Catering Services_bookings') || '[]');
      bookings.push({ ...state.formData, ref, submitted: new Date().toISOString() });
      localStorage.setItem('Adusab Catering Services_bookings', JSON.stringify(bookings));
